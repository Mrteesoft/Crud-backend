 ...
 */
router.get('/', (0, cache_1.cacheMiddleware)((req) => `purchases:${req.user?.id}:list:${req.originalUrl}`), purchaseController_1.getPurchases);
/**
 * @openapi
 * /purchases/{id}:
 *   get:
 ...
 */
router.get('/:id', (0, cache_1.cacheMiddleware)((req) => `purchases:${req.user?.id}:${req.params.id}`), purchaseController_1.getPurchaseById);
/**
 * @openapi
 * /purchases/{id}:
 *   patch:
 ...
 */
router.get('/:id/installments', (0, cache_1.cacheMiddleware)((req) => `purchases:${req.user?.id}:${req.params.id}:installments`), purchaseController_1.getInstallments);
/**
 * @openapi
 * /purchases/{id}/pay:
 *   post:
